...
import profileRouter from "../module/profile/profile.route.mjs";
...
const setupRoutes = async (app) => {
    ...
    app.use(`/api/${version}/profile`, Auth, profileRouter);
    app.use(`/api/${version}/users`, Auth, checkPermissions(constant.PERMISSIONS.ADMIN), userRouter);
